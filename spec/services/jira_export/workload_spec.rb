curl -u x@x.com:x -v -H "Accept: application/json" -H "Content-type: application/json" -X POST \
   -d "{ \"comment\": \"test api\", \"started\": \"2014-01-02T11:50:00.000+0000\", \"timeSpent\": \"10m\" }" \
   https://vtelligence.atlassian.net/rest/api/2/issue/SPD-862/worklog\?adjustEstimate\=auto
